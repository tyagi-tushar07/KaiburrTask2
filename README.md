<i><h3>This is the implemenation of the Swagger With Spring Boot & MongoDB.</i></h3>A full customizable API documentation is created using swagger. All the request are tested and saved in MongoDB.
